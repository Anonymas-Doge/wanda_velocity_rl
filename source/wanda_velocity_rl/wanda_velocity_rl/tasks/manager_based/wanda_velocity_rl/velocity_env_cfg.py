...
class EventCfg:
    ...
    reset_robot_joints = EventTerm(
        ...
        mode="reset",
        params={
            "position_range": (0.0, 0.0), #(0.5, 1.5), adding noise to joints causes invalid articulation state
...
class RewardsCfg:
    ...
    base_linear_velocity = RewTerm(
        ...
        weight=5.0,
        params={"std": 0.25, "ramp_rate": 0.5, "ramp_at_vel": 0.8, "asset_cfg": SceneEntityCfg("robot")},
    )
