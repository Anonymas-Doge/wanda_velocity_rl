...
All the environments are registered in the `wanda_velocity_rl` extension. They start
...
import wanda_velocity_rl.tasks  # noqa: F401


def main():
    """Print all environments registered in `wanda_velocity_rl` extension."""
